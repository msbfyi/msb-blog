...
### [2.0.0](https://github.com/msbfyi/msb-blog/releases/tag/v2.0.0) (2026-08-21) · [Compare](https://github.com/msbfyi/msb-blog/compare/v1.13.0...v2.0.0)
...
### [1.13.0](https://github.com/msbfyi/msb-blog/releases/tag/v1.13.0) (2026-07-16) · [Compare](https://github.com/msbfyi/msb-blog/compare/v1.12.0...v1.13.0)

- Added a `/cal` interstitial page with a custom og:image.

### [1.12.0](https://github.com/msbfyi/msb-blog/releases/tag/v1.12.0) (2026-02-07) · [Compare](https://github.com/msbfyi/msb-blog/compare/v1.11.0...v1.12.0)
...
### [1.11.0](https://github.com/msbfyi/msb-blog/releases/tag/v1.11.0) (2025-01-16) · [Compare](https://github.com/msbfyi/msb-blog/compare/v1.10.0...v1.11.0)

- Restored DecapCMS.
- Added cache-busting for CSS and JS assets.

### [1.10.0](https://github.com/msbfyi/msb-blog/releases/tag/v1.10.0) (2025-01-07) · [Compare](https://github.com/msbfyi/msb-blog/compare/v1.9.0...v1.10.0)

- Added `/then` links to previous `/now` pages, and automated `/now`/wishlist updates.
- New site logos.

### [1.9.0](https://github.com/msbfyi/msb-blog/releases/tag/v1.9.0) (2024-10-24) · [Compare](https://github.com/msbfyi/msb-blog/compare/v1.8.0...v1.9.0)

- Added the `fediverse:creator` meta tag.
- Fixed `/now` archive date bugs.

### [1.8.0](https://github.com/msbfyi/msb-blog/releases/tag/v1.8.0) (2024-10-21) · [Compare](https://github.com/msbfyi/msb-blog/compare/v1.7.0...v1.8.0)

- Home and links pages now surface the latest This Week In Links issue.

### [1.7.0](https://github.com/msbfyi/msb-blog/releases/tag/v1.7.0) (2024-10-21) · [Compare](https://github.com/msbfyi/msb-blog/compare/v1.6.0...v1.7.0)

- Added a lightbox for images; began migrating toward an eleventy-satisfactory-style config.

### [1.6.0](https://github.com/msbfyi/msb-blog/releases/tag/v1.6.0) (2024-10-17) · [Compare](https://github.com/msbfyi/msb-blog/compare/v1.5.0...v1.6.0)

- Documented the (now-retired) versioning convention in the README.

### [1.5.0](https://github.com/msbfyi/msb-blog/releases/tag/v1.5.0) (2024-10-17) · [Compare](https://github.com/msbfyi/msb-blog/compare/v1.4.0...v1.5.0)

- Upgraded to Eleventy 3.0.

### [1.4.0](https://github.com/msbfyi/msb-blog/releases/tag/v1.4.0) (2024-07-05) · [Compare](https://github.com/msbfyi/msb-blog/compare/v1.3.0...v1.4.0)

- Added Umami analytics (build-time only).
- Added a Clacks Overhead / GNU Terry Pratchett link to the footer.

### [1.3.0](https://github.com/msbfyi/msb-blog/releases/tag/v1.3.0) (2024-06-27) · [Compare](https://github.com/msbfyi/msb-blog/compare/v1.2.0...v1.3.0)
