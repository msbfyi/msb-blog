...
function w(e) {
  ...
  let E2 = 0;
  function m() {
    i = t.substring(E2, o.lastIndex - n[0].length), i && r.children.push({ type: 2, value: i, parent: r });
  }
  for (; n = o.exec(t); ) {
  ...
  return i = t.slice(E2), r.children.push({ type: 2, value: i, parent: r }), a;
}
var O = class {
  constructor(t) {
    this.callback = t;
...
var T2 = 0;
var B = "";
function ee(e, r, t, o2, n, i, a, s) {
  return { value: e, root: r, parent: t, type: o2, props: n, children: i, line: J, column: D3, length: a, return: "", siblings: s };
}
function Re() {
  return T2;
}
function Ce() {
  return T2 = N3 > 0 ? M2(B, --N3) : 0, D3--, T2 === 10 && (D3 = 1, J--), T2;
}
function k3() {
  return T2 = N3 < Oe ? M2(B, N3++) : 0, D3++, T2 === 10 && (D3 = 1, J++), T2;
}
function A2() {
  return M2(B, N3);
}
...
function Ae(e) {
  return J = D3 = 1, Oe = C2(B = e), N3 = 0, [];
}
function Se(e) {
  return B = "", e;
}
function re(e) {
  return Z(te(N3 - 1, de(e === 91 ? e + 2 : e === 40 ? e + 1 : e)));
}
function _e(e) {
  for (; (T2 = A2()) && T2 < 33; )
    k3();
  return ce(e) > 2 || ce(T2) > 3 ? "" : " ";
}
function Me(e, r) {
  for (; --r && k3() && !(T2 < 48 || T2 > 102 || T2 > 57 && T2 < 65 || T2 > 70 && T2 < 97); )
    ;
  return te(e, Y() + (r < 6 && A2() == 32 && k3() == 32));
}
function de(e) {
  for (; k3(); )
    switch (T2) {
...
function ne(e, r, t, o2, n, i, a, s, l) {
  for (var p3 = 0, u2 = 0, c = a, d2 = 0, f2 = 0, m = 0, v2 = 1, b3 = 1, P3 = 1, y2 = 0, I3 = "", E2 = n, x3 = i, g2 = o2, h = I3; b3; )
    switch (m = y2, y2 = k3()) {
      case 40:
        if (m != 108 && M2(h, c - 1) == 58) {
          Ne(h += U2(re(y2), "&", "&\f"), "&\f", pe(p3 ? s[p3 - 1] : 0)) != -1 && (P3 = -1);
          break;
        }
      case 34:
      case 39:
      ...
      case 0:
        switch (y2) {
          ...
          case 125:
            b3 = 0;
          case 59 + u2:
            P3 == -1 && (h = U2(h, /\f/g, "")), f2 > 0 && C2(h) - c && F2(f2 > 32 ? De(h + ";", o2, t, c - 1, l) : De(U2(h, " ", "") + ";", o2, t, c - 2, l), l);
            break;
          case 59:
            h += ";";
          default:
            if (F2(g2 = Fe(h, r, t, p3, u2, n, s, I3, E2 = [], x3 = [], c, i), i), y2 === 123)
              if (u2 === 0)
                ne(h, r, g2, g2, E2, i, c, s, x3);
              else
                switch (d2 === 99 && M2(h, 3) === 110 ? 100 : d2) {
                  case 100:
                  case 108:
                  case 109:
                  case 115:
                    ne(e, g2, g2, o2 && F2(Fe(e, g2, g2, 0, 0, n, s, I3, n, E2 = [], c, x3), x3), n, x3, c, s, o2 ? E2 : x3);
                    break;
                  default:
                    ne(h, g2, g2, g2, [""], x3, 0, s, x3);
                }
        }
        p3 = u2 = f2 = 0, v2 = P3 = 1, I3 = h = "", c = a;
        break;
      case 58:
        c = 1 + C2(h), f2 = m;
      default:
        ...
        switch (h += q2(y2), y2 * v2) {
          ...
          case 44:
            ...
            break;
          case 64:
            A2() === 45 && (h += re(k3())), d2 = A2(), u2 = c = C2(I3 = h += Ve(Y())), y2++;
            break;
          case 45:
            m === 45 && C2(h) == 2 && (v2 = 0);
        }
...
function Fe(e, r, t, o2, n, i, a, s, l, p3, u2, c) {
  for (var d2 = n - 1, f2 = n === 0 ? i : [""], m = ke(f2), v2 = 0, b3 = 0, P3 = 0; v2 < o2; ++v2)
    for (var y2 = 0, I3 = L2(e, d2 + 1, d2 = pe(b3 = a[v2])), E2 = e; y2 < m; ++y2)
      (E2 = Z(b3 > 0 ? f2[y2] + " " + I3 : U2(I3, /&\f/g, f2[y2]))) && (l[P3++] = E2);
  return ee(e, r, t, n === 0 ? Ie : s, l, p3, u2, c);
}
function vt(e, r, t, o2) {
  return ee(e, r, t, Pe, q2(Re()), L2(e, 2, -2), 0, o2);
}
function De(e, r, t, o2, n) {
  return ee(e, r, t, we, L2(e, 0, o2), L2(e, o2 + 1, -1), o2, n);
}
    ...
    if (n.type === "ident") {
        ...
        return { type: "query", prefix: i, mediaType: a };
      {
        ...
        if (c.type === "ident" && c.value === "and") {
          ...
          let { start: b3, end: P3 } = (o2 = e.at(p3 + 2)) !== null && o2 !== void 0 ? o2 : { start: v2, end: v2 };
          return R3(m) ? { errid: "EXPECT_CONDITION", start: b3, end: P3, child: m } : { type: "query", prefix: i, mediaType: a, mediaCondition: m };
        }
    ...
    if (c) {
      ...
      if (u2.feature = f2.value, e.length >= 7) {
          ...
          return { errid: "INVALID_RANGE", start: e[0].start, end: p3.end };
        {
          ...
          let $2 = d2 + 1 + ((l = (s = u2.rightOp) === null || s === void 0 ? void 0 : s.length) !== null && l !== void 0 ? l : 0), G2 = e.at($2);
          if ($2 + 2 !== e.length)
            return { errid: "INVALID_RANGE", start: e[0].start, end: p3.end };
          u2.rightToken = G2;
        }
      ...
      u2.rightToken = f2;
    let m, { leftToken: v2, leftOp: b3, feature: P3, rightOp: y2, rightToken: I3 } = u2, E2, x3;
    if (v2 !== void 0) {
      if (v2.type === "ident") {
        let { type: g2, value: h } = v2;
        h === "infinite" && (E2 = { type: g2, value: h });
      } else if (v2.type === "number" || v2.type === "dimension" || v2.type === "ratio") {
        let { hasSpaceBefore: g2, hasSpaceAfter: h, start: W2, end: $2, ...G2 } = v2;
        E2 = G2;
      }
    }
    if (I3 !== void 0) {
      if (I3.type === "ident") {
        let { type: g2, value: h } = I3;
        h === "infinite" && (x3 = { type: g2, value: h });
      } else if (I3.type === "number" || I3.type === "dimension" || I3.type === "ratio") {
        let { hasSpaceBefore: g2, hasSpaceAfter: h, start: W2, end: $2, ...G2 } = I3;
        x3 = G2;
      }
    }
    if (E2 !== void 0 && x3 !== void 0)
      if (b3 !== "<" && b3 !== "<=" || y2 !== "<" && y2 !== "<=") {
        if (b3 !== ">" && b3 !== ">=" || y2 !== ">" && y2 !== ">=")
          return { errid: "INVALID_RANGE", start: e[0].start, end: p3.end };
        m = { leftToken: E2, leftOp: b3, feature: P3, rightOp: y2, rightToken: x3 };
      } else
        m = { leftToken: E2, leftOp: b3, feature: P3, rightOp: y2, rightToken: x3 };
    else
      (E2 === void 0 && b3 === void 0 && y2 !== void 0 && x3 !== void 0 || E2 !== void 0 && b3 !== void 0 && y2 === void 0 && x3 === void 0) && (m = { leftToken: E2, leftOp: b3, feature: P3, rightOp: y2, rightToken: x3 });
    return m ?? { errid: "INVALID_RANGE", start: e[0].start, end: p3.end };
  }
  return { errid: "INVALID_RANGE", start: e[0].start, end: p3.end };
};
var Ue = (e) => ({ type: "query-list", mediaQueries: e.mediaQueries.map((r) => Ye(r)) });
var Ye = (e) => e.mediaCondition ? { type: "query", prefix: e.prefix, mediaType: e.mediaType, mediaCondition: me(e.mediaCondition) } : e;
var me = (e) => {
  let r = [];
...
var je = (e) => {
  let r = (() => {
    let n;
    return he ? n = he : (n = new TextEncoder(), he = n), n;
...
var ge = { "aspect-ratio": { feature: "aspect-ratio", type: "ratio", bounds: [false, [0, 1], [1 / 0, 1], false] }, "device-aspect-ratio": { feature: "device-aspect-ratio", type: "ratio", bounds: [false, [0, 1], [1 / 0, 1], false] } };
var j2 = (e) => Object.entries(e).filter((r) => r[1] !== void 0);
var et = new Set(Object.keys(se));
var tt = (e) => et.has(e[0]);
var le = (e) => et.has(e);
var rt = new Set(Object.keys(ge));
var K = (e) => rt.has(e[0]);
var z3 = (e) => rt.has(e);
...
var it = (e) => xe(e) || K(e);
var be = (e) => ot(e) || z3(e);
var Ee = (e) => ot(e) || z3(e) || le(e);
var V = (e, r) => {
  e[r[0]] = r[1];
};
var ae = (...e) => e.reduce((r, t) => r === "{true}" ? t : t === "{true}" ? r : r === "{false}" || t === "{false}" ? "{false}" : ((o2, n) => {
  let [i, a, s, l] = o2, p3 = typeof a == "number" ? a : a[0] / a[1], u2 = typeof s == "number" ? s : s[0] / s[1], [c, d2, f2, m] = n, v2 = typeof d2 == "number" ? d2 : d2[0] / d2[1], b3 = typeof f2 == "number" ? f2 : f2[0] / f2[1], P3 = i !== c && !i;
  p3 !== v2 && (P3 = p3 > v2);
  let y2 = l !== m && !l;
  u2 !== b3 && (y2 = u2 < b3);
  let I3 = P3 ? i : c, E2 = P3 ? a : d2, x3 = y2 ? s : f2, g2 = y2 ? l : m;
  return E2 > x3 || E2 === x3 && (!I3 || !g2) ? "{false}" : [I3, E2, x3, g2];
})(r, t), "{true}");
var ue = (e) => {
  if (K(e)) {
    let { bounds: r } = ge[e[0]], t = ae(e[1], r);
    if (typeof t == "string")
      return t;
...
var at = (e) => {
  ...
  let { bounds: r } = ge[e[0]], [t, o2, n, i] = e[1], a = o2[0] / o2[1], s = n[0] / n[1], l = r[1][0] / r[1][1], p3 = r[0], u2 = r[2][0] / r[2][1], c = r[3], d2 = s > u2 || s === u2 && !(c && !i);
...
var X = (e) => e.type === "number" && e.value > 0 ? [e.value, 1] : e.type === "ratio" ? [e.numerator, e.denominator] : null;
var H = (e, r) => {
  let t = Q[r];
  if (e.type === "infinite") {
    if (r === "resolution")
      ...
      if (t[o2[0]] !== void 0) {
        ...
        if (o2[0] !== "media-type") {
          if (o2[0] === "invalid-features")
            ...
            let i = t;
            xe(o2) || K(o2) ? V(i, [o2[0], ae(i[o2[0]], o2[1])]) : o2[0] === "color-gamut" || o2[0] === "video-color-gamut" ? i[o2[0]] = [i[o2[0]][0] && o2[1][0], i[o2[0]][1] && o2[1][1], i[o2[0]][2] && o2[1][2], i[o2[0]][3] && o2[1][3]] : V(i, [o2[0], i[o2[0]] === o2[1] ? i[o2[0]] : "{false}"]);
          }
        }
      }
    } else
...
var It = (e, r) => {
  ...
  if (t.type === "invalid")
    return o2;
  if (t.type === "boolean")
    return t.name === "color-gamut" ? [{ "color-gamut": [false, true, true, true] }] : t.name === "grid" ? [{ grid: 1 }] : le(t.name) ? dt({ [t.name]: "none" }) : z3(t.name) ? [{ [t.name]: [false, [0, 1], [Number.POSITIVE_INFINITY, 1], true] }] : [{ [t.name]: [false, 0, Number.POSITIVE_INFINITY, true] }];
  if (le(t.name)) {
    if (t.type === "equals") {
      let n = t.value;
      if (t.name === "grid") {
  ...
  }
  {
    ...
    if (t.type === "equals") {
      ...
      let i = H(t.min, t.name), a = H(t.max, t.name);
      i !== null && a !== null && (n = [t.minOp === "<=", i, a, t.maxOp === "<="]);
    }
    return n === null ? o2 : [{ [t.name]: ue([t.name, n]) }];
  }
...
var Te = (e, r) => {
  ...
  for (let o2 of e.children)
    "context" in o2 ? t.push(It(o2, r)) : t.push(Te(o2, r));
    ...
    for (let s of j2(n))
      if (s[0] !== "invalid-features") {
        if (s[0] === "color-gamut") {
          ...
          it(s) && (s[1] = ue(s));
        s[1] === "{false}" ? (o2.add(s[0]), i = true) : s[1] === "{true}" || s[0] === "media-type" && s[1] === "all" || V(a, s);
      }
    i || r.push(a);
  }
...
var Nt = (e, r = {}) => {
  ...
  for (let n of e.mediaQueries) {
    let i = [];
    n.prefix === "not" ? (n.mediaType === "print" ? i.push({ "media-type": "not-print" }) : n.mediaType === "screen" && i.push({ "media-type": "not-screen" }), n.mediaCondition !== void 0 && i.push(...ct(Te(n.mediaCondition, t)))) : n.mediaCondition === void 0 ? i.push({ "media-type": n.mediaType }) : i.push(...Te(n.mediaCondition, t).map((a) => ({ ...a, "media-type": n.mediaType }))), o2.push(...i);
  }
  return wt(o2);
};
var ft = (e, r = {}) => {
...
var w3 = (e) => new Error(`Invalid option: ${e}`);
var Ot = (e) => {
